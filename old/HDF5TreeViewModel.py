...
#---------------------
class file_name():
    def __init__(self, varProj):
        self.__fname = varProj
    def show_proj(self):
        print self.__fname
        return self.__fname
class HDF5TreeViewModel (QtGui.QStandardItemModel) :
    ...
    def __init__(self, parent=None):
        ...
        temp = f.get_node(f.root, "varProj")  
        self.varProj = temp.read()
        f.close()

        # !!!!! THE /data/ SUBDIRECTORY SHOULD BE OMITTED IN PATH !!!!!
        self.apppath_icon_folder_closed = ':/data_icons/folder_closed.gif'
        self.apppath_icon_data          = ':/data_icons/table.gif'

        self.icon_folder_open   = QtGui.QIcon()
        self.icon_folder_open.addPixmap(QtGui.QPixmap(':/data_icons/folder_open.gif'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.icon_folder_closed = QtGui.QIcon()
        self.icon_folder_closed.addPixmap(QtGui.QPixmap(':/data_icons/folder_closed.gif'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.icon_data          = QtGui.QIcon()
        self.icon_data.addPixmap(QtGui.QPixmap(':/data_icons/table.gif'), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def _model_hdf5_tree(self) :
        ...
        fname = str(os.getcwd) + self.varProj
        print 'Makes the tree view model for HDF5 file : ' + self.varProj
        f = h5py.File(self.varProj, 'r') # open read-only
