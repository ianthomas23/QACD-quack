...
class Ui_NewPhaseClusterDialog(object):
    def setupUi(self, NewPhaseClusterDialog):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(50, 510, 511, 211))
        ...
        self.statusLabel.setGeometry(QtCore.QRect(70, 480, 571, 16))
    ...
    def retranslateUi(self, NewPhaseClusterDialog):
        ...
        self.statusLabel.setText(_translate("NewPhaseClusterDialog", "TextLabel"))
