...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.zoom2Label = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.zoom2Label.sizePolicy().hasHeightForWidth())
        self.zoom2Label.setSizePolicy(sizePolicy)
        self.zoom2Label.setObjectName("zoom2Label")
        self.gridLayout.addWidget(self.zoom2Label, 0, 5, 1, 2)
        ...
        self.undoColourmapButton = QtWidgets.QToolButton(self.centralwidget)
        self.undoColourmapButton.setObjectName("undoColourmapButton")
        self.gridLayout.addWidget(self.undoColourmapButton, 1, 5, 1, 1)
        self.redoColourmapButton = QtWidgets.QToolButton(self.centralwidget)
        self.redoColourmapButton.setObjectName("redoColourmapButton")
        self.gridLayout.addWidget(self.redoColourmapButton, 1, 6, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.zoom2Label.setText(_translate("MainWindow", "Colourmap zoom"))
        ...
        self.undoColourmapButton.setToolTip(_translate("MainWindow", "Undo previous colourmap zoom"))
        self.undoColourmapButton.setText(_translate("MainWindow", "Undo"))
        self.redoColourmapButton.setToolTip(_translate("MainWindow", "Redo next colourmap zoom"))
        self.redoColourmapButton.setText(_translate("MainWindow", "Redo"))
