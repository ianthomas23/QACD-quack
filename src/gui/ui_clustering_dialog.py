...
class Ui_ClusteringDialog(object):
    def setupUi(self, ClusteringDialog):
        ...
        sizePolicy.setHeightForWidth(ClusteringDialog.sizePolicy().hasHeightForWidth())
        ClusteringDialog.setSizePolicy(sizePolicy)
        ...
        self.kMinimumSpin.setMaximum(30)
        ...
        self.kMaximumSpin.setMaximum(30)
