...
class Ui_DisplayOptionsDialog(object):
    def setupUi(self, DisplayOptionsDialog):
        ...
        self.showMeanMedianStdLinesCheckBox = QtWidgets.QCheckBox(self.histogramTab)
        self.showMeanMedianStdLinesCheckBox.setObjectName("showMeanMedianStdLinesCheckBox")
        self.v.addWidget(self.showMeanMedianStdLinesCheckBox)
        self.showMeanMedianStdValuesCheckBox = QtWidgets.QCheckBox(self.histogramTab)
        self.showMeanMedianStdValuesCheckBox.setObjectName("showMeanMedianStdValuesCheckBox")
        self.v.addWidget(self.showMeanMedianStdValuesCheckBox)
    ...
    def retranslateUi(self, DisplayOptionsDialog):
        ...
        self.showMeanMedianStdLinesCheckBox.setText(_translate("DisplayOptionsDialog", "Show mean, median and standard deviation lines"))
        self.showMeanMedianStdValuesCheckBox.setText(_translate("DisplayOptionsDialog", "Show mean, median and standard deviation values in legend"))
