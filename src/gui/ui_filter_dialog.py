...
class Ui_FilterDialog(object):
    def setupUi(self, FilterDialog):
        ...
        FilterDialog.resize(197, 109)
        self.layoutWidget = QtWidgets.QWidget(FilterDialog)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 10, 174, 85))
        self.layoutWidget.setObjectName("layoutWidget")
        self.formLayout = QtWidgets.QFormLayout(self.layoutWidget)
        self.formLayout.setContentsMargins(0, 0, 0, 0)
        self.formLayout.setObjectName("formLayout")
        self.pixelTotalsCheckBox = QtWidgets.QCheckBox(self.layoutWidget)
        ...
        self.medianFilterCheckBox = QtWidgets.QCheckBox(self.layoutWidget)
